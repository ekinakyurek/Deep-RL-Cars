...
public class CarManager : MonoBehaviour
{
	...
	*/
	...
	public static int actionNum =9;
	public static int d_queue_length = 1;
	public Queue<List<double>> d_queue;
	public static int state_size = d_queue_length * (nsensor+1);
...
//			current_dist.Add (transform.rotation [1]); current_dist.Add (transform.rotation [3]);
			...
			if (training) {
				...
				if (returnCounts [returnCounts.Count - 1] % GameBehaviour.RTT == 0) {
					Qnetwork.lr = Qnetwork.lr * Qnetwork.lr_decay;
